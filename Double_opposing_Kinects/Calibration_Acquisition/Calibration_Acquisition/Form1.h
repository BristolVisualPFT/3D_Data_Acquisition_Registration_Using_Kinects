...
namespace Calibration_Acquisition {
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->recordOptions->Items->AddRange(gcnew cli::array< System::Object^  >(4) {L"Record RGB", L"Record Depth", L"Record Skeleton", 
				L"Record Infrared"});
			this->recordOptions->Location = System::Drawing::Point(131, 70);
			this->recordOptions->Name = L"recordOptions";
			this->recordOptions->Size = System::Drawing::Size(113, 64);
			this->recordOptions->TabIndex = 2;
			// 
			// label2
			// 
			this->label2->AutoSize = true;
			this->label2->Location = System::Drawing::Point(38, 94);
			...
			this->displayOptions->Items->AddRange(gcnew cli::array< System::Object^  >(4) {L"Show RGB", L"Show Depth", L"Show Skeleton", 
				L"Show Infrared"});
			this->displayOptions->Location = System::Drawing::Point(131, 152);
			this->displayOptions->Name = L"displayOptions";
			this->displayOptions->Size = System::Drawing::Size(113, 64);
			...
			this->label7->Location = System::Drawing::Point(34, 7);
			...
			this->Name = L"Form1";
			this->Text = L"Kinect Calibration Acquisition";
...
#pragma endregion
	...
	private: System::Void Form1_Load(System::Object^  sender, System::EventArgs^  e) {
				 ...
				 this->recordOptions->SetItemCheckState(3,CheckState::Checked);
				 this->displayOptions->SetItemCheckState(0,CheckState::Checked);
				 this->displayOptions->SetItemCheckState(3,CheckState::Checked);
	...
	private:	 void InitState()
				 {
					 ...
					 if (this->displayOptions->GetItemCheckState(2) == CheckState::Checked)
						 m_bViewBody = true;
					 if (this->displayOptions->GetItemCheckState(3) == CheckState::Checked)
						 m_bViewForce = true;
					 ...
					 if (this->recordOptions->GetItemCheckState(2) == CheckState::Checked)
						 m_bSaveBody = true;
					 if (this->recordOptions->GetItemCheckState(3) == CheckState::Checked)
						 m_bSaveForce = true;
	...
	private: System::Void OnRGBEncodeOptionsCheck(System::Object^  sender, System::Windows::Forms::ItemCheckEventArgs^  e) {
				 /* if (this->encodeoptions->GetItemCheckState(0) == CheckState::Checked)
				 this->encodeoptions->SetItemCheckState((e->Index + 1)%2,CheckState::Checked);
				 MessageBox::Show("Clicked" + e->Index);*/
			 }
